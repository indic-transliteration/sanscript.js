...
function exportSanscriptSingleton(global) {
    ...
    var schemes = Sanscript.schemes = {
            ...
            "tamil_extended": {
                ...
                "vowel_marks": ["ா", "ி", "ீ", "ு", "ூ", "ৃ", "ৄ", "ৢ", "ৣ", "ெ", "ே", "ை", "ொ", "ோ", "ௌ"],
                "other_marks": ["ং", "ঃ", "ঁ"],
                "virama": ["்"],
                "consonants": ["க", "খ", "গ", "ঘ", "ங", "ச", "ছ", "ஜ", "ঝ", "ஞ", "ட", "ঠ", "ড", "ঢ", "ண", "த", "থ", "দ", "ধ", "ந", "ப", "ফ", "ব", "ভ", "ம", "ய", "ர", "ல", "வ", "ஶ", "ஷ", "ஸ", "ஹ", "ள", "க்ஷ", "ஜ்ஞ"],
                "symbols": ["০", "১", "২", "৩", "৪", "৫", "৬", "৭", "৮", "৯", "ௐ", "ঽ", "।", "॥"],
                "candra": ["ெ"],
                "other": ["க়", "খ়", "গ়", "ஜ়", "ড়", "ঢ়", "ফ়", "ய়", "ற"]
            },
            "tamil_superscripted": {
            ...
            "thai": {
                ...
                "virama": ["्"],
                "consonants": ["क", "ख", "ग", "घ", "ङ", "च", "छ", "ज", "झ", "ञ", "ट", "ठ", "ड", "ढ", "ण", "त", "थ", "द", "ध", "न", "प", "फ", "ब", "भ", "म", "य", "र", "ल", "व", "श", "ष", "स", "ह", "ळ", "क्ष", "ज्ञ"],
                "symbols": ["०", "१", "२", "३", "४", "५", "६", "७", "८", "९", "ॐ", "ऽ", "ฯ", "๚"],
                "candra": ["ॅ"],
                "other": ["क़", "ख़", "ग़", "ज़", "ड़", "ढ़", "फ़", "य़", "ऱ"]
            },
